...
import {type RegisterByInvitationRequest, registerByWorkspaceInvitation} from "../../../shared/api/workspaceUsers";
...
> = ({token}) => {
    ...
    const registerMutation = useMutation({
        mutationFn: async (values: RegisterByInvitationFormValues) => {
            ...
            if (!parsed.success) {
                form.setFields(
                    parsed.error.issues.map((issue) => ({
                        name: issue.path as [keyof RegisterByInvitationFormValues],
            ...
            const request: RegisterByInvitationRequest = {
